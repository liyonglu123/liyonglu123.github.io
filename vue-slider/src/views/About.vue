    ...
    <div id="login">
        <el-form class="loginFrom" :model="logindata" :rules="rules" ref="ruleForm">
            ...
            <el-form-item prop="userName">
                <el-input class="login-inputorbuttom" prefix-icon="el-icon-user" placeholder="登录名" v-model="logindata.userName"></el-input>
            </el-form-item>
            <el-form-item prop="password">
                <el-input class="login-inputorbuttom" prefix-icon="el-icon-lock" placeholder="密码" v-model="logindata.password"></el-input>
            </el-form-item>
        ...
        ></el-input>
            ...
            <el-form-item class="login-item">
                <el-button class="login-inputorbuttom login-bottom" type="primary" v-popover:popover @click="visible = !visible">登 录</el-button>
            </el-form-item>
        </el-form>
        <!--验证码弹窗-->
    ...
    export default {
        ...
        methods: {
            ...
            draw(mx = 200, bx = 20, y = 50) {
                ...
                let imgsrc = "http://img0.ph.126.net/CXbGJWqudtgL0yTBsmjMZA==/1105633708537445535.jpg";
...
<style scoped lang="less">
    #login {
        ...
        width: 100%;
        height: 100%;
        background-image: url("http://img0.ph.126.net/CXbGJWqudtgL0yTBsmjMZA==/1105633708537445535.jpg");
